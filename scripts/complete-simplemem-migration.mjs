...
function mustReplace(value, pattern, replacement, label) {
  ...
  if (next === value) throw new Error(`migration pattern did not match: ${label}`);
  return next;
}
